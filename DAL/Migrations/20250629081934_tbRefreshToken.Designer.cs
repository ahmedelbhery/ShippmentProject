...
namespace DAL.Migrations
{
    ...
    [Migration("20250629081934_tbRefreshToken")]
    partial class tbRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.TbShippingType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.TbShippment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.TbShippmentStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.TbUserSebder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.TbShippment", b =>
                {
                    ...
                    b.HasOne("Domain.TbUserSebder", "Sender")
                        .WithMany("TbShippments")
                        .HasForeignKey("SenderId")
                        .IsRequired()
                        .HasConstraintName("FK_TbShippments_TbUserSebders");

                    b.HasOne("Domain.TbShippingType", "ShippingType")
                        .WithMany("TbShippments")
            ...
            modelBuilder.Entity("Domain.TbShippmentStatus", b =>
                {
                    ...
                    b.HasOne("Domain.TbShippment", "Shippment")
                        .WithMany("TbShippmentStatuses")
